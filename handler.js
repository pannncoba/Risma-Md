...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = '© Pann - MD'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'Pann - MD'
        global.kontak2 = [
        ['18552042201', 'Pann', '𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𝑩𝒐𝒕', 'https://vt.tiktok.com/ZSRLtYjku/', true],
        ['62895411246945', await this.getName('62895411246945@s.whatsapp.net'), 'PANN²', 'https://vt.tiktok.com/ZSRLtYjku/', true], 
        ]
